...
// create the unit
// Jedan kvadratic zmice, 1px je to small
const box = 32;
...
let food = {
    x : Math.floor(Math.random()*17+1) * box, // from 1 to 17
    y : Math.floor(Math.random()*15+3) * box // from 3 to 18
}
...
function direction(event){
    ...
    if( key == 37 && d != "RIGHT"){ // moramo da provjerimo trenutnu direkciju !
        left.play();
        d = "LEFT";
